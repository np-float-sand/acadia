...
| National equipment-category demand (Census M3 / BLS PPI / Fed IP) | FRED keyless CSV endpoint (`grid_equipment_basket/data/category_demand.py`) | None. Electrical-equipment new orders / backlog / book-to-bill, transformer vs switchgear PPI. Maker-rotation signal built on it FAILED (`docs/category-demand-rotation-results.md`); kept as a dashboard series only |
